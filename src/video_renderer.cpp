...
namespace Videooio{
    ...
    bool video_renderer::video_reader_open(const char* filename) {
    ...
    bool video_renderer::video_reader_read_frame(uint8_t* frame_buffer, int64_t* pts) {
    ...
    bool video_renderer::video_reader_seek_frame( int64_t ts) {
